...
export default {
  ...
  computed: {
    firstQuiz() {
      return this.$store.getters["quiz/getSubTestOfTest"]('PME et Cadres supérieurs', 'subtest 3-1')
    },
    secondQuiz() {
      return this.$store.getters["quiz/getSubTestOfTest"]('PME et Cadres supérieurs', 'subtest 3-2')
    },
    thirdQuiz() {
      return this.$store.getters["quiz/getSubTestOfTest"]('PME et Cadres supérieurs', 'subtest 3-3')
    },
    fourthQuiz() {
      return this.$store.getters["quiz/getSubTestOfTest"]('PME et Cadres supérieurs', 'subtest 3-4')
    },
