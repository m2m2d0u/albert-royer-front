<template>
  <v-container fluid class="bg-dark text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s"
               v-if="!this.$store.state.quiz.isLoading">
    <v-container class="container py-5">
