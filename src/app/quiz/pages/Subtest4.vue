  ...
  <v-container class="mt-10">
    ...
    <div>
      <md-steppers :md-active-step.sync="active" md-linear>
        ...
        <!--        &lt;!&ndash;        Second quiz, when we purpose some picture and the recipient take some response by different choice&ndash;&gt;
                <md-step id="second"
                ...
                &lt;!&ndash;Third quiz, we give to the recipient two different pictures and the response depend for his choice&ndash;&gt;
                <md-step id="third"
